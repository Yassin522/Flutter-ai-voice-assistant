...
class _HomePageState extends State<HomePage> {
  ...
  final sugg = ["Play", "Stop", "Play Radio", "Pause", "Play next station"];
      ...
      drawer: Drawer(
        child: Container(
          ...
          child: VStack(
            [
              100.heightBox,
              "All Radio".text.xl.white.semiBold.make().p16(),
              10.heightBox,
              ListView(
                padding: Vx.m0,
                shrinkWrap: true,
      ...
      body: Stack(
        children: [
          VxAnimatedBox()
              ...
              .make()
              .shimmer(
                  primaryColor: Vx.purple500, secondaryColor: Vx.blue500),
          [
            AppBar(
